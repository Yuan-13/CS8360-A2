...
To get the better understanding of the data distribution of this dataset, I did the following some EDA works. First of all, I drew the graph of Fish count vs Fish species to explore the dataset distribution across specise is even or not. The image below shows the result. From the line graph, we can easily the distrition is relatively even. The difference between majority class and minority class number is within 60 instances.
<p align="center"><img width="100%" src="./Fish Species distritbution.png" /></p>
